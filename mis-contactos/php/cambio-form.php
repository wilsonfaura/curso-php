...
<div>
	...
	<input type="radio" id="m" name="sexo_rdo" title="Tu sexo" value="M" <?php if($registro_contacto["sexo"]=="M") echo "checked"; ?> required />&nbsp;<label for="m">Maculino</label>
	&nbsp;&nbsp;&nbsp;
...
<div>
	...
	<input type="number" id="telefono" class="cambio" name="telefono_txt" placeholder="escribe tu telefono" title="Tu telefono" value="<?php echo $registro_contacto["telefono"]; ?>" required />
</div>
<div>
